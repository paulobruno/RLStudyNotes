...
\maketitle
    ...
    \section{Aviso sobre bibliografia}
    
        Antes de qualquer coisa, fica o aviso: esses estudos foram baseados quase totalmente baseados no livro de introdução ao aprendizado por reforço:
        ...
        Naturalmente que consultei outras referências eventualmente, mas, no geral, essas notas são notas de estudo desse livro. Sugiro \textbf{muito fortemente} a leitura dele, principalmente por ser de graça.
